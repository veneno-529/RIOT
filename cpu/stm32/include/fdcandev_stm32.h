 ...
 * @{
 */
/* think if this needs to be changed it should be 32 for STM32H7 */
#define FDCAN_STM32_TX_MAILBOXES 12
    /**< Number of frame the driver can transmit simultaneously */
    /*should be 2 * 128 for STM32H7 */
...
#    define CONFIG_FDCAN_EXT_FILTERS_NUM              0
#  endif
...
#    define CONFIG_FDCAN_RX_BUFFERS_NUM               0U
#  endif
...
#    define CONFIG_FDCAN_TX_BUFFERS_NUM               0U
#  endif
...
#    define CONFIG_FDCAN_TX_FIFO_QUEUE_ELEMENTS       0U
#  endif
 ...
 */
    /**< Rx FIFO size */
#if defined (CPU_FAM_STM32H7)
#  define FDCAN_RXFIFO_ELEMENT_SIZE_WORDS \
...
#  define FDCAN_SRAM_RX_FIFO0_SIZE \
    (CONFIG_FDCAN_RX_FIFO0_ELEMENTS * (FDCAN_RXFIFO_ELEMENT_SIZE_WORDS))

# define FDCAN_SRAM_RX_FIFO1_SIZE \
    (CONFIG_FDCAN_RX_FIFO1_ELEMENTS * (FDCAN_RXFIFO_ELEMENT_SIZE_WORDS))
...
/** FDCAN Message RAM block start addresses */
typedef struct {
